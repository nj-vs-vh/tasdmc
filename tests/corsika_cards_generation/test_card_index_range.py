...
@pytest.mark.parametrize(
    ...
    [
        ...
        param({"all_weights": [1, 1], "my_weight_idx": 0}, 100, range(0, 50)),
        param({"all_weights": [1, 1], "my_weight_idx": 1}, 100, range(50, 100)),
        param({"all_weights": [1, 1, 1], "my_weight_idx": 2}, 100, range(66, 100)),
        param({"all_weights": [1, 2, 1], "my_weight_idx": 1}, 100, range(25, 75)),
        param({"all_weights": [1, 2, 1], "my_weight_idx": 1}, 10, range(3, 7)),
    ]
)
